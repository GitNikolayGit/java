package ru.cherkas.course.config;
...
@Configuration
@ComponentScan("ru.cherkas.course")
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    // для использования шаблонизатора Thymeleaf
    @Override
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ru.cherkas.course.models");
